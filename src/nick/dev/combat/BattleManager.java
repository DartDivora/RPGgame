...
/**************************************************************************
 * This class handles battles actions. TODO: See about implementing animations,
 * damage numbers, etc.
 * 
...
public class BattleManager {
	...
	/*************************************
	 * Action defines all of the different actions someone can perform.
	 *************************************/
	public enum Action {
		Attack, Defend, Spell, Item;
	...
	/************************************************************
	 * Chooses an action for the target and then executes that and the player's
	 * actions.
	 ************************************************************/
	...
	/************************************************************
	 * Executes one action. This is where the battle logic will go for each
	 * action.
	 ************************************************************/
	public String executeAction(Action action, int sourceIndex, int targetIndex) {
		...
		case Item:
			return "Items do not work yet, you dingus!";
		default:
			return null;
		}
	}
