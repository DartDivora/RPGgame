...
/**
 * This class listens for any Mouse presses/clicks. Implements MouseListener and
 * MouseMotionListener.
 * 
...
public class MouseManager implements MouseListener, MouseMotionListener {
	...
	/**
	 * List of possible mouse buttons we can check for. Add new ones as needed,
	 * but make sure to initialize them in the constructor.
	 * 
	 * @author nsanft,acharles
	 *
	 */
	...
	/**
	 * Arrays that keep track of the mouse buttons and which have been clicked
	 * and checked for.
	 */
	...
	/**
	 * Current x and y positions of the mouse. Should never be null, so maybe we
	 * don't need that check. Probably not important.
	 */
	private Integer x, y;

	/**
	 * Map of all Buttons to their corresponding button code. Lets us check
	 * based on name.
	 */
	...
	/**
	 * mouseIsClicked returns whether or not a mouse button is pressed - only
	 * returns true once, so do not use for repeating input.
	 * 
	 * @param button
	 * @return
	 */
	...
	/**
	 * mouseIsDown returns whether or not a mouse button is currently being held
	 * down.
	 * 
	 * @param button
	 * @return whether or not a Mouse Button is down.
	 */
	 ...
	 * functionality with mousePressed and mouseReleased. Can use this instead
	 * if we need to, but for now, what we have works.
	 */
	@Override
